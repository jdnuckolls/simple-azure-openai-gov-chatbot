...
resource webApp 'Microsoft.Web/sites@2022-03-01' = {
  ...
  properties: {
    ...
    siteConfig: {
  	...
  	{name: 'AZURE_OPENAI_ENDPOINT', value: 'https://your-openai.openai.azure.com'}
  	{name: 'AZURE_OPENAI_API_KEY', value: '<azure-openai-key>'}
  	...
  	{name: 'AZURE_SEARCH_ENDPOINT', value: 'https://your-search.search.windows.net'}
  	{name: 'AZURE_SEARCH_KEY', value: '<search-key>'}
  	{name: 'AZURE_SEARCH_INDEX_NAME', value: '<index-name>'}
  	{name: 'AZURE_SEMANTIC_CONFIGURATION', value: '<your-semantic-config-name>'}
  	{name: 'USE_VECTOR_SEARCH', value: 'true'}
  	{name: 'AZURE_VECTOR_PROFILE', value: '<your-vector-profile-name>'}
  	{name: 'MAX_SOURCE_CHARACTERS', value: '1500'}
  	{name: 'ENABLE_SPEECH', value: 'true'}
  	{name: 'AZURE_SPEECH_KEY', value: '<speech-key>'}
  	{name: 'AZURE_SPEECH_REGION', value: '<your-region>'}
